...
namespace EntityFrameworkCore.SingleStore.IntegrationTests.Commands{
    ...
    public class TestMigrateCommand : ITestMigrateCommand
    {
        ...
        public void Run(){
            ...
            var csb = new SingleStoreConnectionStringBuilder(AppConfig.Config["Data:ConnectionString"]);
        ...
        private static bool DatabaseContainsTablesExact(string[] allExpectedTables)
        {
            ...
            using var connection = new SingleStoreConnection(AppConfig.Config["Data:ConnectionString"]);
            connection.Open();
