...
{
    public class StoreGeneratedSingleStoreTest : StoreGeneratedTestBase<StoreGeneratedSingleStoreTest.StoreGeneratedSingleStoreFixture>
    {
        ...
        public class StoreGeneratedSingleStoreFixture : StoreGeneratedFixtureBase
        {
