...
namespace Microsoft.EntityFrameworkCore.Diagnostics
{
    ...
    /// <summary>
    ///     <para>
    ///         Event IDs for SingleStore events that correspond to messages logged to an <see cref="ILogger" />
    ...
    ///     </para>
    /// </summary>
    public static class SingleStoreEventId
    {
        ...
        /// <summary>
        ///     <para>
        ///         A byte property is set up to use a SingleStore identity column.
        ///     </para>
        ///     <para>
        ///         This event is in the <see cref="DbLoggerCategory.Model.Validation" /> category.
        ///     </para>
