...
{
    public abstract class SingleStoreJsonOptionsExtension
        : IDbContextOptionsExtension
    {
        private DbContextOptionsExtensionInfo _info;

        protected SingleStoreJsonOptionsExtension()
        {
        }

        protected SingleStoreJsonOptionsExtension([NotNull] SingleStoreJsonOptionsExtension copyFrom)
        {
        ...
        protected abstract SingleStoreJsonOptionsExtension Clone();

        public virtual SingleStoreJsonChangeTrackingOptions JsonChangeTrackingOptions { get; set; }
        ...
        /// </summary>
        public virtual SingleStoreJsonOptionsExtension WithJsonChangeTrackingOptions(SingleStoreCommonJsonChangeTrackingOptions options)
        ...
        public virtual SingleStoreJsonOptionsExtension WithJsonChangeTrackingOptions(SingleStoreJsonChangeTrackingOptions options)
        {
            var clone = Clone();
        ...
        private sealed class ExtensionInfo : DbContextOptionsExtensionInfo
        {
            ...
            private new SingleStoreJsonOptionsExtension Extension
                => (SingleStoreJsonOptionsExtension)base.Extension;
            ...
            {
                debugInfo["SingleStore:" + Extension.UseJsonOptionName] = "1";
                debugInfo["SingleStore:" + nameof(JsonChangeTrackingOptions)]
