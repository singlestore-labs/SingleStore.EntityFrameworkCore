...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </summary>
    public static class SingleStoreEntityTypeBuilderExtensions
    {
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(SingleStoreAnnotationNames.CharSet, charSet, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(SingleStoreAnnotationNames.CharSetDelegation, delegationModes, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(SingleStoreAnnotationNames.CollationDelegation, delegationModes, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            var options = entityTypeBuilder.Metadata.GetTableOptions();
            UpdateTableOption(name, value, options);
            var optionsString = SingleStoreEntityTypeExtensions.SerializeTableOptions(options);

            return entityTypeBuilder.CanSetAnnotation(SingleStoreAnnotationNames.StoreOptions, optionsString, fromDataAnnotation);
        }
