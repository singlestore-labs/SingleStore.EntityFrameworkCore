...
namespace EntityFrameworkCore.SingleStore.Storage.Internal
{
    ...
    public class SingleStoreScaffoldingConnectionSettings
    {
        ...
        public SingleStoreScaffoldingConnectionSettings(string connectionString)
        {
        ...
        protected virtual bool Equals(SingleStoreScaffoldingConnectionSettings other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((SingleStoreScaffoldingConnectionSettings)obj);
        }
