...
{
    public class SingleStoreDatabaseCreator : RelationalDatabaseCreator
    {
        private readonly ISingleStoreRelationalConnection _relationalConnection;
        ...
        /// </summary>
        public SingleStoreDatabaseCreator(
            [NotNull] RelationalDatabaseCreatorDependencies dependencies,
            [NotNull] ISingleStoreRelationalConnection relationalConnection,
...
WHERE table_type = 'BASE TABLE' AND table_schema = '" + _relationalConnection.DbConnection.Database + "'");
        ...
        private IReadOnlyList<MigrationCommand> CreateCreateOperations()
        {
            ...
            return Dependencies.MigrationsSqlGenerator.Generate(
                new[]
                {
                    new SingleStoreCreateDatabaseOperation
                    {
        ...
        private static bool IsDoesNotExist(SingleStoreException exception) => exception.Number == 1049;

        private bool RetryOnExistsFailure(SingleStoreException exception)
        {
        ...
        private IReadOnlyList<MigrationCommand> CreateDropCommands()
        {
            ...
            {
                throw new InvalidOperationException(SingleStoreStrings.NoInitialCatalog);
            }
            ...
            var operations = new MigrationOperation[]
            {
                ...
                // Issue #775
                new SingleStoreDropDatabaseOperation { Name = _relationalConnection.DbConnection.Database }
            };
        ...
        private static void ClearAllPools() => global::SingleStoreConnector.SingleStoreConnection.ClearAllPools();

        // Clear connection pool for the database connection since after the 'create database' call, a previously
        // invalid connection may now be valid.
        private void ClearPool() => global::SingleStoreConnector.SingleStoreConnection.ClearPool((global::SingleStoreConnector.SingleStoreConnection)_relationalConnection.DbConnection);
    }
}
