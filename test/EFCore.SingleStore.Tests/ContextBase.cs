...
namespace EntityFrameworkCore.SingleStore
{
    public class ContextBase : DbContext
    {
        ...
        private Action<SingleStoreDbContextOptionsBuilder> _mySqlOptions;
        ...
        {
            _serviceProvider = (serviceCollection ?? new ServiceCollection().AddEntityFrameworkSingleStore())
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if (_model != null)
            {
                var conventionSet = SingleStoreConventionSetBuilder.Build();
