...
namespace Microsoft.EntityFrameworkCore.Migrations
{
    ...
    /// </summary>
    public static class SingleStoreMigrationBuilderExtensions
    {
        /// <summary>
        ///     <para>
        ...
        public static bool IsSingleStore([NotNull] this MigrationBuilder migrationBuilder)
            => string.Equals(migrationBuilder.ActiveProvider,
                typeof(SingleStoreOptionsExtension).GetTypeInfo().Assembly.GetName().Name,
                StringComparison.Ordinal);

        /// <summary>
        ///     Builds an <see cref="SingleStoreDropPrimaryKeyAndRecreateForeignKeysOperation" /> to drop an existing primary key and optionally
        ...
        public static OperationBuilder<SingleStoreDropPrimaryKeyAndRecreateForeignKeysOperation> DropPrimaryKey(
            ...
            bool recreateForeignKeys = false)
        {
            ...
            var operation = new SingleStoreDropPrimaryKeyAndRecreateForeignKeysOperation
            {
                Schema = schema,
                Table = table,
                Name = name,
            ...
            return new OperationBuilder<SingleStoreDropPrimaryKeyAndRecreateForeignKeysOperation>(operation);
        }

        /// <summary>
        ///     Builds an <see cref="SingleStoreDropPrimaryKeyAndRecreateForeignKeysOperation" /> to drop an existing unique constraint and optionally
        ///     recreate all foreign keys of the table.
        /// </summary>
        /// <param name="migrationBuilder"> The migrationBuilder from the parameters on <see cref="Migration.Up(MigrationBuilder)" /> or <see cref="Migration.Down(MigrationBuilder)" />. </param>
        ...
        /// foreign keys of the table be be dropped before the primary key is dropped, and created again afterwards.</param>
        /// <returns> A builder to allow annotations to be added to the operation. </returns>
        public static OperationBuilder<SingleStoreDropUniqueConstraintAndRecreateForeignKeysOperation> DropUniqueConstraint(
            [NotNull] this MigrationBuilder migrationBuilder,
            [NotNull] string name,
            [NotNull] string table,
            [CanBeNull] string schema = null,
            bool recreateForeignKeys = false)
        {
            ...
            var operation = new SingleStoreDropUniqueConstraintAndRecreateForeignKeysOperation
            {
                Schema = schema,
                Table = table,
                Name = name,
            ...
            return new OperationBuilder<SingleStoreDropUniqueConstraintAndRecreateForeignKeysOperation>(operation);
        }
    }
}
