...
namespace EntityFrameworkCore.SingleStore.Json.Newtonsoft.Extensions.Internal
{
    /// <summary>
    ...
    /// </summary>
    public static class SingleStoreInternalJsonNewtonsoftPropertyExtensions
    {
        /// <summary>
        ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
        ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
        ...
        public static void SetJsonChangeTrackingOptions([NotNull] this IMutableProperty property, SingleStoreJsonChangeTrackingOptions? options)
        {
            ...
            property.SetValueComparer(
                valueComparer is ISingleStoreJsonValueComparer mySqlJsonValueComparer
                    ...
                    : SingleStoreJsonNewtonsoftValueComparer.Create(property.ClrType, options.Value));
        }
    }
}
