...
{
    public static class SingleStoreIndexBuilderExtensions
    {
        #region FullText

        // TODO: Remove/Hide for .NET 5.
        [Obsolete("This extension method is obsolete. Use IsFullText instead.")]
        public static IndexBuilder ForSingleStoreIsFullText([NotNull] this IndexBuilder indexBuilder, bool fullText = true)
            => IsFullText(indexBuilder, fullText);

        // TODO: Remove/Hide for .NET 5.
        [Obsolete("This extension method is obsolete. Use IsFullText instead.")]
        public static IndexBuilder<TEntity> ForSingleStoreIsFullText<TEntity>([NotNull] this IndexBuilder<TEntity> indexBuilder, bool fullText = true)
            => IsFullText(indexBuilder, fullText);
        ...
        public static IndexBuilder ForSingleStoreIsSpatial([NotNull] this IndexBuilder indexBuilder, bool spatial = true)
            => IsSpatial(indexBuilder, spatial);

        // TODO: Remove/Hide for .NET 5.
        [Obsolete("This extension method is obsolete. Use IsSpatial instead.")]
        public static IndexBuilder<TEntity> ForSingleStoreIsSpatial<TEntity>([NotNull] this IndexBuilder<TEntity> indexBuilder, bool spatial = true)
            => IsSpatial(indexBuilder, spatial);
