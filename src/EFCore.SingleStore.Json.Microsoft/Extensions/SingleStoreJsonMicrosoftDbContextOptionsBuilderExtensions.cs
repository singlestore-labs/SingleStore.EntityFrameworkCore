...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </summary>
    public static class SingleStoreJsonMicrosoftDbContextOptionsBuilderExtensions
    {
        /// <summary>
        ...
        public static SingleStoreDbContextOptionsBuilder UseMicrosoftJson(
            ...
            SingleStoreCommonJsonChangeTrackingOptions options = SingleStoreCommonJsonChangeTrackingOptions.RootPropertyOnly)
        {
            ...
            var extension = (coreOptionsBuilder.Options.FindExtension<SingleStoreJsonMicrosoftOptionsExtension>() ??
