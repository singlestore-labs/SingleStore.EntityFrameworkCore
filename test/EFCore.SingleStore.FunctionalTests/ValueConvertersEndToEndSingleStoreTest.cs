...
{
    public class ValueConvertersEndToEndSingleStoreTest
        : ValueConvertersEndToEndTestBase<ValueConvertersEndToEndSingleStoreTest.ValueConvertersEndToEndSingleStoreFixture>
    {
        public ValueConvertersEndToEndSingleStoreTest(ValueConvertersEndToEndSingleStoreFixture fixture)
            : base(fixture)
        {
        }
        ...
        public class ValueConvertersEndToEndSingleStoreFixture : ValueConvertersEndToEndFixtureBase
        {
