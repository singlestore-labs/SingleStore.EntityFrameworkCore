...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// To mark a string as containing JSON data, just cast the string to `SingleStoreJsonString`.
    /// </summary>
    public sealed class SingleStoreJsonString : IConvertible
    {
        private readonly string _json;

        private SingleStoreJsonString(string json)
            => _json = json;

        public static implicit operator string(SingleStoreJsonString jsonStringObject)
            => jsonStringObject._json;

        public static implicit operator SingleStoreJsonString(string stringObject)
            => new SingleStoreJsonString(stringObject);

        public static bool operator ==(SingleStoreJsonString left, SingleStoreJsonString right)
            => left?.Equals(right) ?? ReferenceEquals(right, null);

        public static bool operator !=(SingleStoreJsonString left, SingleStoreJsonString right)
            => !(left == right);

        public static bool operator ==(SingleStoreJsonString left, string right)
            => left?.Equals(right) ?? ReferenceEquals(right, null);

        public static bool operator !=(SingleStoreJsonString left, string right)
            => !(left == right);

        private bool Equals(SingleStoreJsonString other)
            => _json == other._json;
        ...
        public override bool Equals(object obj)
            => ReferenceEquals(this, obj) ||
               obj is SingleStoreJsonString other && Equals(other) ||
