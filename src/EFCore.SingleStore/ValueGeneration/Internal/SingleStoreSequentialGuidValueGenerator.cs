...
{
    public class SingleStoreSequentialGuidValueGenerator : ValueGenerator<Guid>
    {
        private readonly ISingleStoreOptions _options;

        public SingleStoreSequentialGuidValueGenerator(ISingleStoreOptions options)
        {
            _options = options;
        }
        ...
        public virtual Guid Next(DateTimeOffset timeNow)
        {
            ...
            if (_options.ConnectionSettings.GuidFormat == SingleStoreGuidFormat.LittleEndianBinary16)
            {
