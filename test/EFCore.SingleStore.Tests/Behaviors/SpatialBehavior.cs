...
namespace EntityFrameworkCore.SingleStore.Behaviors
{
    ...
    internal class SpatialBehavior : RawSqlTestWithFixture<SpatialBehavior.SpatialBehaviorFixture>
    {
        ...
        [Fact]
        public void SingleStore7_and_MariaDb_use_x_longitude_and_y_latitude_order()
        {
...
FROM `IceCreamShops`;";
        ...
        public class SpatialBehaviorFixture : SingleStoreTestFixtureBase<Model.SpatialBehaviorContext>
        {
