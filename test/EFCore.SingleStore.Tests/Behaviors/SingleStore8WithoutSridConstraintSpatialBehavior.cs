...
namespace EntityFrameworkCore.SingleStore.Behaviors
{
    ...
    public class SingleStore8WithoutSridConstraintSpatialBehavior : RawSqlTestWithFixture<SingleStore8WithoutSridConstraintSpatialBehavior.SingleStore8WithoutSridConstraintSpatialBehaviorFixture>
    {
        public SingleStore8WithoutSridConstraintSpatialBehavior(SingleStore8WithoutSridConstraintSpatialBehaviorFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        }
        ...
        [Fact]
        public void SingleStore8_longitude_latitude_order_depends_on_srid()
        {
...
FROM `IceCreamShops`;";
        ...
        public class SingleStore8WithoutSridConstraintSpatialBehaviorFixture : SingleStoreTestFixtureBase<Model.SpatialBehaviorContext>
        {
...
";
            ...
            public override DbContext CreateDefaultDbContext()
                => CreateContext(
                    ...
                    serviceCollection: collection => collection.AddEntityFrameworkSingleStoreNetTopologySuite());
        }
    }
}
