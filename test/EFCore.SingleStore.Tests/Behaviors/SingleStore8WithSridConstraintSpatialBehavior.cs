...
namespace EntityFrameworkCore.SingleStore.Behaviors
{
    ...
    public class SingleStore8WithSridConstraintSpatialBehavior : RawSqlTestWithFixture<SingleStore8WithSridConstraintSpatialBehavior.SingleStore8WithSridConstraintSpatialBehaviorFixture>
    {
        public SingleStore8WithSridConstraintSpatialBehavior(SingleStore8WithSridConstraintSpatialBehaviorFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        }
        ...
        [Fact]
        public void SingleStore8_uses_x_latitude_and_y_longitude_order_for_srid_4326()
        {
...
FROM `IceCreamShops`;";
        ...
        public class SingleStore8WithSridConstraintSpatialBehaviorFixture : SingleStoreTestFixtureBase<Model.SpatialBehaviorContext>
        {
