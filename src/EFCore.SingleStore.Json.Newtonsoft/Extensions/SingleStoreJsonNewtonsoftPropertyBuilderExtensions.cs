...
using EntityFrameworkCore.SingleStore.Json.Newtonsoft.Extensions;
...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </summary>
    public static class SingleStoreJsonNewtonsoftPropertyBuilderExtensions
    {
        /// <summary>
        ...
        public static PropertyBuilder UseJsonChangeTrackingOptions(
            ...
            SingleStoreCommonJsonChangeTrackingOptions? options)
        {
