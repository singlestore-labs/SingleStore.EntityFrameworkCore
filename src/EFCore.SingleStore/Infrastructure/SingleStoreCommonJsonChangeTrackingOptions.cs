...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// `UseJsonChangeTrackingOptions` extension method when calling `SingleStoreDbContextOptionsBuilder.UseMicrosoftJson()`
    /// or `SingleStoreDbContextOptionsBuilder.UseNewtonsoftJson()`, or for a specific model property when calling
    ...
    /// </summary>
    [Flags]
    public enum SingleStoreCommonJsonChangeTrackingOptions
    {
        /// <summary>
