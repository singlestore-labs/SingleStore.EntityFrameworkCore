...
namespace EntityFrameworkCore.SingleStore.Storage.ValueConversion.Internal
{
    ...
    /// </summary>
    public class GeometryValueConverter<TGeometry> : ValueConverter<TGeometry, SingleStoreGeometry>
        where TGeometry : Geometry
    {
        ...
        private static SingleStoreGeometry ConvertToProviderCore(TGeometry v)
            => SingleStoreGeometry.FromWkb(v.SRID, v.ToBinary());

        private static TGeometry ConvertFromProviderCore(SingleStoreGeometry v)
        {
