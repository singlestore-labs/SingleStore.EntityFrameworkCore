...
namespace EntityFrameworkCore.SingleStore.Query.ExpressionTranslators.Internal
{
    ...
    /// </summary>
    public class SingleStoreSpatialDbFunctionsExtensionsMethodTranslator : IMethodCallTranslator
    {
        ...
        private static readonly MethodInfo _spatialDistancePlanarMethodInfo = typeof(SingleStoreSpatialDbFunctionsExtensions).GetRuntimeMethod(nameof(SingleStoreSpatialDbFunctionsExtensions.SpatialDistancePlanar), new[] {typeof(DbFunctions), typeof(Geometry), typeof(Geometry)});
        private static readonly MethodInfo _spatialDistanceSphere = typeof(SingleStoreSpatialDbFunctionsExtensions).GetRuntimeMethod(nameof(SingleStoreSpatialDbFunctionsExtensions.SpatialDistanceSphere), new[] {typeof(DbFunctions), typeof(Geometry), typeof(Geometry), typeof(SpatialDistanceAlgorithm)});

        public SingleStoreSpatialDbFunctionsExtensionsMethodTranslator(
