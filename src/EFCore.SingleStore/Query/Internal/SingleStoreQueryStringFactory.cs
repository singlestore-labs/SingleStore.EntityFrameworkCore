...
namespace EntityFrameworkCore.SingleStore.Query.Internal
{
    ...
    public class SingleStoreQueryStringFactory : IRelationalQueryStringFactory
    {
        ...
        public SingleStoreQueryStringFactory([NotNull] IRelationalTypeMappingSource typeMapper)
        {
        ...
        protected virtual void PrepareCommand(DbCommand command)
        {
            ...
            var parser = new SingleStoreCommandParser(command.CommandText);
